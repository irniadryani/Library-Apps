      ...
      <div className="drawer !h-screen lg:drawer-open">
        ...
        <div className="drawer-side">
          ...
          <ul className="menu bg-[#C9DABF] text-[#5F6F65] text-lg font-bold !h-screen w-80 p-4 overflow-y-auto mx-5 rounded-xl shadow-xl ">
            <li 
              className={`mt-5 ${
                location.pathname === "/" ? "bg-[#9db391] rounded-lg text-white" : ""
              }`}
            >
              <a href="/">
                <BiSolidHome />
            ...
            <li className={`mt-5 ${
                location.pathname === "/book" ? "bg-[#9db391] rounded-lg text-white" : ""
              }`}>
              <a href="/book">
                <ImList2 />
                List Books
            ...
            <li className={`mt-5 ${
                location.pathname === "/transaction" ? "bg-[#9db391] rounded-lg text-white" : ""
              }`}>
              <a href="/transaction">
                <GrTransaction />
                Transaction
